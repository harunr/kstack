...
setTimeout(function() { 
  $('.home-methodology-item-wrap').removeClass('has_scroll');
}, 2000);
...
setTimeout(function() { 
 $p_this.addClass('line_up');
  ...
  jQuery(".home-methodology-item-wrap").addClass("increase_height");
  jQuery(".methodology-sub-title").fadeOut(800);
  ...
  if( tb_index == 0){
    ...
    $('#scrollArea').delay(1600).animate({
      scrollLeft: $('#scrollArea').scrollLeft()==0
    }, 2000);
    return false;
  }
  else if( tb_index == 3){
    $('#scrollArea').delay(1950).animate({
      scrollLeft: $('#scrollArea').scrollLeft()==0
    }, 1800);
    return false;
  }
...
jQuery(".full-process-btn").on("click",function(){
  ...
  $('.home-methodology-item-wrap').addClass('has_scroll');
